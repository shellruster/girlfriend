...
async fn girlfriend(file_path: &str) -> Result<(), AnyError> {
    ...
    js_runtime
        .execute_script("[girlfriend:runtime.js]", RUNTIME_JAVASCRIPT_CORE)
        .unwrap();
...
fn main() {
    let runtime = tokio::runtime::Builder::new_current_thread()
        ...
        .build()
        .unwrap();
    if let Err(error) = runtime.block_on(girlfriend("./example.ts")) {
